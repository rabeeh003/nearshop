from .views import cus_signup,cus_signin, cus_details, owner_register, shop_register, shopsall, shop_update, shop_login, owner_login, owner_mail_check, getOneShop, ShopListViewBasedLocation, Verify_email_token
...
urlpatterns = [
    ...
    path('verify_email_token/<uuid:token>/', Verify_email_token, name='verifyEmailToken'),
