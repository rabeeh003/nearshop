...
export default function CollapsibleTable() {
    ...
    async function fetchData(shopId) {
        try {
            ...
            // Fetch all products
            const allProductsResponse = await axios.get(`https://www.nearbazar.shop/api/s/getproductbyshop/?shop=${shopId}`)
            ...
            // Fetch orders
            const ordersResponse = await axios.get('https://www.nearbazar.shop/api/s/orders/');
